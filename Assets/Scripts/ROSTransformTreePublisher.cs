...
{
    public bool PublishMapFrame = true;
    [SerializeField]
    ...
    void Start()
    {
        var rootController = gameObject.GetComponentInParent<AGVController>();
        var ns = rootController.Namespace;
        m_Topic = $"/{(ns != "" ? ns + "/" : "")}tf";
        ...
        m_ROS.RegisterPublisher<TFMessageMsg>(m_Topic);
    ...
    void PublishMessage()
    {
        ...
        m_ROS.Publish(m_Topic, tfMessage);
